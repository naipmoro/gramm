...
$[ src/test/resources/split-file/set-mbox-ta-basics.mm $]
$[ src/test/resources/split-file/set-mbox-ta-xdiv.mm $]
$[ src/test/resources/split-file/set-mbox-ta-algtop.mm $]
$[ src/test/resources/split-file/set-mbox-ta-ucm.mm $]
$[ src/test/resources/split-file/set-mbox-ta-rrhom.mm $]
$[ src/test/resources/split-file/set-mbox-ta-logb.mm $]
$[ src/test/resources/split-file/set-mbox-ta-ind.mm $]
$[ src/test/resources/split-file/set-mbox-ta-esum.mm $]
$[ src/test/resources/split-file/set-mbox-ta-ofc.mm $]
$[ src/test/resources/split-file/set-mbox-ta-meas.mm $]
$[ src/test/resources/split-file/set-mbox-ta-itgm.mm $]
...
$[ src/test/resources/split-file/set-mbox-ta-eulerpart.mm $]
$[ src/test/resources/split-file/set-mbox-ta-proba.mm $]
$[ src/test/resources/split-file/set-mbox-ta-ballot.mm $]
