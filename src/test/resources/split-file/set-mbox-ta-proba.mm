...
$)
  ...
  $( The Probbiliy of the universe set is 1 (Second axiom of Kolmogorov)
  ...
  ${
    $d x y P $.
    $( A Probbiliy is bounded in [ 0 , 1 ] (First axiom of Kolmogorov)
  ...
  $( The Probbiliy of the empty event set is 0.  (Contributed by Thierry
     Arnoux, 25-Dec-2016.) $)
  ...
  $( The probabiliy of the difference of two event sets (Contributed by Thierry
     Arnoux, 12-Dec-2016.) $)
  ...
  $( A probabiliy law is increasing with regard to event set inclusion.
