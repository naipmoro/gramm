...
$(
-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-
        The canonical embedding of the rational numbers into a division ring
-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-
$)
...
$(
-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-
             The canonical embedding of ` RR ` into a complete ordered field
-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-
$)
  ...
  ${
    ...
    rrhf.3 $e |- ( ph -> ( ZMod ` R ) e. NrmMod ) $.
    rrhf.4 $e |- ( ph -> ( chr ` R ) = 0 ) $.
    rrhf.5 $e |- ( ph -> R e. TopSp ) $.
    rrhf.6 $e |- ( ph -> R e. CUnifSp ) $.
    rrhf.7 $e |- ( ph -> K e. Haus ) $.
    rrhf.8 $e |- ( ph -> ( UnifSt ` R ) = ( metUnif ` D ) ) $.
    ...
    rrhcn $p |- ( ph -> ( RRHom ` R ) e. ( J Cn K ) ) $=
      ( cfv cq crrh cqqh ccnext co ccn ctps wcel wceq rrhval syl ccnfld cr cuss
      cress eqid rebase cioo crn ctg ctopn tgioo3 3eqtri cvv reex qssre ressabs
      wss mp2an eqcomi fveq2i cnfldtps resstps ccusp recusp cuspusp ax-mp cmetu
      a1i cusp cucn czlm cds cxp cres qqhucn eqcomd oveq2d eleqtrd ccl qdensere
      fveq1i eqtri ucnextcn eqeltrd ) ADUASZDUBSZEFUCUDSZEFUEUDADUFUGWOWQUHODEF
      
      RWMWN $.
    ...
    rrhf $p |- ( ph -> ( RRHom ` R ) : RR --> B ) $=
      ( cr cfv crrh wf cuni cioo crn ctg ccn wcel eqid rrhcn uniretop cnf eqidd
      co syl ctps wceq tpsuni feq23d mpbird ) ASBDUATZUBSFUCZVAUBZAVAUDUEUFTZFU
      GUNUHVCABCDVDFGVDUIIJKLMNOPQRUJVAVDFSVBUKVBUIULUOASBSVBVAASUMADUPUHBVBUQO
      BFDIJURUOUSUT $.
  $}

$(
      @( The ` RRHom ` homomorphism leaves rational numbers unchanged.  @)
      rrhqima @p |- ( ( ph /\ Q e. QQ ) -> ( ( RRHom ` R ) ` Q ) = Q ) @=
        ? @.
...
$)
  ...
  ${
    ...
    rrhre $p |- ( RRHom ` ( CCfld |`s RR ) ) = ( _I |` RR ) $=
      ( va vb ccnfld cr co cfv cres wceq wtru uniretop wcel a1i cvv ax-mp crest
      cq eqid cc wss qssre vx cress crrh cid cioo crn ctg rehaus cabs cmin ccom
      cha cxp cds reex cnfldds ressds reseq1i rebase ctopn tgioo3 cdr cfield wa
      ccrg refld isfld mpbi simpli cnrg cnnrg resubdrg subrgnrg mp2an czlm cnlm
      csubrg rezh cchr cc0 cofld reofld ofldchr ctps ccms cmt recms cmsms mstps
      mp2b ccusp recusp cuss cmetu ressuss cnflduss oveq1i wne cpsmet ne0i cxmt
      c0 0re cnxmet xmetpsmet ax-resscn restmetu mp3an 3eqtri rrhcn ctopon ctop
      ccn retop toptopon idcn ccnext wf wf1o f1oi f1of fss ccl qdensere cv cnei
      csn cflf cima wrex wi wral cin simplr simpr opnneip mp3an12 syl wb trud
      syl3anc fvex qex elrestr inss2 resiima inss1 eqsstri imaeq2 sseq1d rspcev
      syl2anc ex ralrimiva ancli cfil eleq2i biimpri trnei mpbid mp3an13 mpbird
      isflf adantl creg cusp cuspusp uspreg resabs1 cnrest cnextfres cqqh elexi
      eqeltrri rrhval qqhre fveq2i eqtri 3eqtr4i hauseqcn ) CDUBEZUCFZUDDGZHIPU
      
      UVTYT $.
  $}
