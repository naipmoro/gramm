...
public class Proof {
     ...
     * @param label the name of the assertion being proved
     ...
     * {@link Proof#verifyCompressed()} and a normal proof to
...
//    }
     ...
     *
     * @return true if the normal proof is verified, otherwise false
     */
     ...
     *
     * @return true if the compressed proof is verified, otherwise false
     */
